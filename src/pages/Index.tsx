            ...
            <div className="text-center space-y-8">
              ...
              <div className="bg-gradient-to-r from-wedding-cream to-white p-8 rounded-lg">
                <h3 className="font-['Cormorant'] text-2xl font-semibold text-wedding-dark mb-6">
                  Наша загадочная история
                </h3>
                <div className="space-y-4 text-wedding-gray leading-relaxed text-lg">
                  <p>
                    История нашей любви началась весьма загадочно... Сначала были Лера и Вика, 
                    потом что-то пошло не так. А тем временем наша Арина немного пополнела 
                    (но это совершенно нормально!).
                  </p>
                  <p>
                    Самое интересное началось, когда какие-то случайные фото попали генералу в личку. 
                    Никто до сих пор не знает, как это произошло, но именно благодаря этому недоразумению 
                    мы с Катей и познакомились по-настоящему!
                  </p>
                  <p className="font-medium text-wedding-dark">
                    Иногда самые неожиданные повороты судьбы приводят к самому счастливому финалу. 
                    Теперь мы готовы начать нашу собственную главу!
                  </p>
                </div>
                
                {/* Friends Photo */}
                <div className="mt-6 text-center">
                  <p className="text-sm text-wedding-gray mb-3">Наши верные кенты, которые всё это видели:</p>
                  <img 
                    src="https://cdn.poehali.dev/files/47911f33-aa98-4eb6-a99e-24833b6909fb.jpg" 
                    alt="Наша компания друзей" 
                    className="rounded-lg shadow-md mx-auto max-w-xs w-full"
                  />
                  <p className="text-xs text-wedding-gray mt-2">
                    Они знают всю правду о нашей истории! 😄
                  </p>
                </div>
              </div>
